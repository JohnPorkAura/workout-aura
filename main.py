"""
Workout aura — A personalised 544u5ig
...
DB_FILE      = "workout_aura.db"
SYSTEM_PROMPT = "You are an expert Workout aura assistant. Enter your fitness level, goals, available equipment, and time. Get a structured weekly workout plan."

app = FastAPI(title="Workout aura")
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Workout aura</div>
    <div class="auth-sub">A personalised 544u5ig</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Workout aura</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Workout aura</em><br>A personalised 544u5ig</h1>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <input type="text" id="field-fitness_level" placeholder="" required>
    </div>
    <div class="field">
      <label for="field-goals">goals</label>
      <input type="text" id="field-goals" placeholder="">
    </div>
    <div class="field">
      <label for="field-equipment">equipment</label>
      <input type="text" id="field-equipment" placeholder="">
    </div>
    <div class="field">
      <label for="field-days_per_week">days per week</label>
      <input type="text" id="field-days_per_week" placeholder="">
    </div>
    <div class="btn-row">
  ...
  <footer>
    <div class="foot-note">Workout aura &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Workout aura assistant. Enter your fitness level, goals, available equipment, and time. Get a structured weekly workout plan.",
  promptTemplate: "fitness level: {{fitness_level}}\\ngoals: {{goals}}\\nequipment: {{equipment}}\\ndays per week: {{days_per_week}}",
  resultFormat:   'steps', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "fitness_level", "label": "fitness level", "type": "text", "placeholder": "", "required": true, "options": []}, {"id": "goals", "label": "goals", "type": "text", "placeholder": "", "required": false, "options": []}, {"id": "equipment", "label": "equipment", "type": "text", "placeholder": "", "required": false, "options": []}, {"id": "days_per_week", "label": "days per week", "type": "text", "placeholder": "", "required": false, "options": []}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Workout aura", "ai_ready": bool(GROQ_API_KEY)}
